#!/usr/bin/env python3
"""Create script using all 8 GPUs"""
import paramiko
...
OUTPUT_DIR = "models/soc-analyst-mistral"
...
client.exec_command("echo '" + encoded + "' | base64 -d > soc_training/train.py")

# Verify compile
stdin, stdout, stderr = client.exec_command("python3 -m py_compile soc_training/train.py && echo OK")
print("Compile:", stdout.read().decode())

# Start with all 8 GPUs
print("Starting with 8 GPUs...")
cmd = "cd soc_training && CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 nohup /nlsasfs/home/isea/isea13/soc_training/venv/bin/python train.py --epochs 2 > training.log 2>&1 &"
client.exec_command(cmd)

print("Started with 8 GPUs!")
client.close()
